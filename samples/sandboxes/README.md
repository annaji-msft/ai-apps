...
| 04 | [swarms](scenarios/04-swarms) | Orchestrator coordinating many sandbox workers — variants 01 (MI inception: orchestrator sandbox spawns workers in another group via its group's MI) and 03 (same plus an Azure Blob container as durable shared scratchpad) ship now; variant 02 (Azure Functions + Durable Task Scheduler) planned | ✅ ready |
