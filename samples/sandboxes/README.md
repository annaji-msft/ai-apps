...
| 04 | [swarms](scenarios/04-swarms) | Orchestrator coordinating many sandbox workers — variant 01 ships now (MI inception: orchestrator sandbox spawns workers in another group via its group's managed identity); variant 02 (Azure Functions + Durable Task Scheduler) planned | ✅ ready |
